    ...
    return (
        <main className="dark text-foreground">
            <div className="font-normal items-center justify-center flex flex-col h-auto text-center">
                ...
                <p>
                    1.1 Хостинг - сервис ByteNode предоставляющие услуги хостинга серверов Minecraft, GDPS, либо услуги хостинга Discord Ботов<br/>
                    ...
                    1.7 Сайт - это совокупность связанных между собой веб-страниц, размещенных в сети Интернет по уникальному URL адресу “ByteNode.one” а также его субдоменах.<br/>
                </p>
                <h2 className="text-2xl mt-[10px]">2. Общие Положения</h2>
                <p>
                    2.1 Использование сайта ByteNode Пользователем означает согласие с настоящей Политикой конфиденциальности и условиями обработки персональных данных Пользователя.<br/>
                    2.2 В случае несогласия с условиями Политики конфиденциальности Пользователь должен прекратить использование услуг хостинга ByteNode.<br/>
                ...
                <p>
                    ...
                    конфиденциальности персональных данных, которые Пользователь предоставляет по запросу Администрации при регистрации на сайте ByteNode.<br/>
                    ...
                    заполнения форм регистрации на сайте ByteNode и включают в себя следующую информацию:<br/>
                ...
                <p>
                    ...
                    4.1.1. Идентификации Пользователя, зарегистрированного на сайте ByteNode для его дальнейшей авторизации.<br/>
                    4.1.2. Предоставления Пользователю доступа к персонализированным данным сайта ByteNode.<br/>
                    4.1.3. Подтверждения достоверности и полноты персональных данных, предоставленных Пользователем.<br/>
                    4.1.4. Создания учетной записи для использования частей сайта ByteNode, если Пользователь дал согласие на создание учетной записи.<br/>
                    4.1.5. Уведомления Пользователя по электронной почте.<br/>
                    4.1.6. Предоставления Пользователю эффективной технической поддержки при возникновении проблем, связанных с использованием сайта ByteNode.<br/>
                </p>
                <h2 className="text-2xl mt-[10px]">5. Права и обязанности сторон</h2>
                <p>
                    5.1. Пользователь вправе:<br/>
                    5.1.1. Принимать свободное решение о предоставлении своих персональных данных, необходимых для использования сайта ByteNode, и давать согласие на их обработку.<br/>
                ...
                <p>
                    ...
                    как к части сайта ByteNode, несет лицо, предоставившее такую информацию.<br/>
                    6.5. Пользователь соглашается, что информация, предоставленная ему как часть сайта ByteNode, может являться объектом интеллектуальной собственности,
                    права на который защищены и принадлежат другим Пользователям, партнерам или рекламодателям, которые размещают такую информацию на сайте ByteNode.<br/>
                    ...
                    невозможности сохранения какого-либо Содержания и иных коммуникационных данных, содержащихся на сайте ByteNode или передаваемых через него.<br/>
                    ...
                    6.9. Администрация не несет ответственность за какую-либо информацию, размещенную пользователем на сайте ByteNode, включая, но не ограничиваясь: информацию,
                ...
                <p className="mb-[60px]">
                    ...
                    7.2. Новая Политика конфиденциальности вступает в силу с момента ее размещения на сайте ByteNode, если иное не предусмотрено новой редакцией Политики конфиденциальности.<br/>
                    7.3. Все предложения или вопросы касательно настоящей Политики конфиденциальности следует сообщать по адресу: contact@ByteNode.one<br/>
                    7.4. Действующая Политика конфиденциальности размещена на странице по адресу https://ByteNode.one/privacy
                </p>
            </div>
        </main>
    );
